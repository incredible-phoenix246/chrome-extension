(function (root, factory) {
  ...
  var util = {
    ...
    addEvent:
      "attachEvent" in Element.prototype
  ...
  */
  ...
  function Draggable(element, options) {
    ...
    util.assign(me, {
      ...
      element: element,
      handle:
        options.handle && isElement(options.handle) ? options.handle : element,
  ...
  function getStyle(element) {
    return "currentStyle" in element
  ...
  function isElement(thing) {
    return (
      ...
      (typeof HTMLDocument !== "undefined" && thing instanceof HTMLDocument)
    );
  }
